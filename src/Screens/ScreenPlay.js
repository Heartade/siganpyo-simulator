...
&hashtag=#"+this.state.tableName.replace(' ','_')))}}>
        ...
        <div style={modal_style}>
          ...
          <p style={{fontSize: "0.8rem", maxWidth: "480px", wordWrap: "normal", fontWeight: "lighter", margin: "24px", marginTop: "32px", color: "#DDDDDD"}}>
            화살표 키를 사용하거나 화면 좌우 및 위쪽 가장자리를 터치하여
            화면 아래에서 위로 올라가는 수업과 공강을
            움직일 수 있습니다.<br/><br/>
            한 수업이 네 시간을 넘어가면 학생들의 항의로
            시간표가 조정됩니다.<br/><br/>
            수강신청 버튼을 누르는 간절함으로
            마음에 드는 시간표를 만들어 보세요.<br/><br/>
            왼쪽 위의 시간표 이름을 누르면
            이름을 변경할 수도 있습니다.<br/><br/>
